...
- **Client:** `cd client && npm run dev` (vite), `npm test` (vitest + jsdom, 319 tests + 3 skipped), `npm run lint` (eslint), `npm run typecheck` (tsc --noEmit)
...
│   │   └── tests/              # Vitest tests (jsdom env, globals), 319 tests + 3 skipped
...
### Client Tests (`client/src/tests/`) — 319 tests + 3 skipped
...
2. `test` — Vitest server (166 tests) + client (319 tests + 3 skipped)
